...
- Updated dependencies
  - @tailrace/core@0.2.2
  - @tailrace/adapter@0.2.2
  - @tailrace/ai-sdk@0.2.2
...
- Initial release: `createCloudflareTailrace`, `withCloudflareAgents().forChat`, `wrapOnToolCall` (Compose via `@tailrace/ai-sdk`).
