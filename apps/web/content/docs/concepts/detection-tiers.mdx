...
For regex-shaped org IDs, use **`definePatternRecognizer`** (static validation, bounded scanning). See [Write custom recognizers](/docs/guides/write-custom-recognizers).
